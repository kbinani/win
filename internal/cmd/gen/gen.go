...
func main() {
	...
	for dll, funcList := range funcs {
		types, exportedFuncs, err := printFuncs(funcList, removeFileExt(dll), *flagOutputDir, all, functions)
		if err != nil {
			panic(err)
		}
...
func createTypedefFile(referencedTypes *StringSet, dir string) error {
	...
	fmt.Fprintf(typesFile, "// This file was automatically generated by https://github.com/kbinani/win/blob/generator/internal/cmd/gen/gen.go\n")
	...
	for _, arch := range []string{"386", "amd64"} {
		...
		archTypesFilePath := filepath.Join(dir, fmt.Sprintf("types_%s.go", arch))
		fp, err := os.Create(archTypesFilePath)
		if err != nil {
			return err
		}
		fmt.Fprintf(fp, "// This file was automatically generated by https://github.com/kbinani/win/blob/generator/internal/cmd/gen/gen.go\n")
		fmt.Fprintf(fp, "\n")
		...
		fp.Close()
		if err := gofmt(archTypesFilePath); err != nil {
			return err
		}
	}
...
func printFuncs(funcs []Func, dllName, dir string, all bool, functions *StringSet) (requiredTypes *StringSet, printedFuncs []Func, e error) {
	...
	// Headers
	fmt.Fprintf(f, "// This file was automatically generated by https://github.com/kbinani/win/blob/generator/internal/cmd/gen/gen.go\n")
	if all {
		fmt.Fprintf(f, "// go run internal/cmd/gen/gen.go\n")
	} else {
		fmt.Fprintf(f, "// go run internal/cmd/gen/gen.go --functions=%s\n", strings.Join(functions.Values(), ","))
	}
	fmt.Fprintf(f, "\n")
	header := []string{
		"// +build windows",
