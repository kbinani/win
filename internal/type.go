...
func (tt Type) getGoName() (goName string, isConstType bool, funcDeclStr string, isPtrType bool, e error) {
	...
	table := map[string]string{
		...
		"ENUM_SERVICE_STATUSW":        "ENUM_SERVICE_STATUS",
		"INHERITED_FROMW":             "INHERITED_FROM",
		"HW_PROFILE_INFOW":            "HW_PROFILE_INFO",
		"SERVICE_NOTIFYW":             "SERVICE_NOTIFY",
		"QUERY_SERVICE_CONFIGW":       "QUERY_SERVICE_CONFIG",
		"QUERY_SERVICE_LOCK_STATUSW":  "QUERY_SERVICE_LOCK_STATUS",
		"VALENTW":                     "VALENT",
		"SERVICE_TABLE_ENTRYW":        "SERVICE_TABLE_ENTRY",
		"ACTRL_ACCESSW":               "ACTRL_ACCESS",
		"ACTRL_PROPERTY_ENTRYW":       "ACTRL_PROPERTY_ENTRY",
		"ACTRL_AUDITW":                "ACTRL_AUDIT",
		"ACTRL_ACCESS_ENTRYW":         "ACTRL_ACCESS_ENTRY",
	...
	tablePtr := map[string]string{
		...
		"GLvoid*":                            "uintptr",
		"GLvoid**":                           "uintptr",
		"PLOCALMANAGEDAPPLICATION":           "PLOCALMANAGEDAPPLICATION",
		"PHKEY":                              "*HKEY",
		"PHANDLE":                            "*HANDLE",
		...
		"PEXPLICIT_ACCESS_W":                 "PEXPLICIT_ACCESS",
		"PTRUSTEE_W":                         "PTRUSTEE",
		...
		"PCREDENTIAL_TARGET_INFORMATIONW":    "PCREDENTIAL_TARGET_INFORMATION",
		"LPDWORD":                            "LPDWORD",
		"PCREDENTIALW*":                      "*PCREDENTIAL",
		"PCREDENTIAL_TARGET_INFORMATIONW*":   "*PCREDENTIAL_TARGET_INFORMATION",
		"PCRED_MARSHAL_TYPE":                 "PCRED_MARSHAL_TYPE",
		"LPENUM_SERVICE_STATUSW":             "LPENUM_SERVICE_STATUS",
		"PENCRYPTION_CERTIFICATE_HASH_LIST":  "PENCRYPTION_CERTIFICATE_HASH_LIST",
		"PENCRYPTION_CERTIFICATE_HASH":       "PENCRYPTION_CERTIFICATE_HASH",
		"PEFS_HASH_BLOB":                     "PEFS_HASH_BLOB",
		"PFN_OBJECT_MGR_FUNCTS":              "PFN_OBJECT_MGR_FUNCTS",
		"PINHERITED_FROMW":                   "PINHERITED_FROM",
		"INHERITED_FROMW*":                   "*INHERITED_FROM",
		"PACCESS_MASK":                       "PACCESS_MASK",
		"LPHW_PROFILE_INFOW":                 "LPHW_PROFILE_INFO",
		"PEXPLICIT_ACCESS_W*":                "*PEXPLICIT_ACCESS",
		"PMANAGEDAPPLICATION":                "PMANAGEDAPPLICATION",
		"PWAITCHAIN_NODE_INFO":               "PWAITCHAIN_NODE_INFO",
		"PTOKEN_INFORMATION_CLASS":           "PTOKEN_INFORMATION_CLASS",
		"PINSTALLDATA":                       "PINSTALLDATA",
		"PQUOTA_LIMITS":                      "PQUOTA_LIMITS",
		"PSID_NAME_USE":                      "PSID_NAME_USE",
		"PTRUSTEE_W*":                        "*PTRUSTEE",
		"PLM_OWF_PASSWORD":                   "PLM_OWF_PASSWORD",
		"PNT_OWF_PASSWORD":                   "PNT_OWF_PASSWORD",
		"PENCRYPTED_LM_OWF_PASSWORD":         "PENCRYPTED_LM_OWF_PASSWORD",
		"PSAMPR_ENCRYPTED_USER_PASSWORD":     "PSAMPR_ENCRYPTED_USER_PASSWORD",
		"PSERVICE_NOTIFYW":                   "PSERVICE_NOTIFY",
		"LPSERVICE_STATUS_PROCESS":           "LPSERVICE_STATUS_PROCESS",
		"PENCRYPTED_NT_OWF_PASSWORD":         "PENCRYPTED_NT_OWF_PASSWORD",
		"PPERF_COUNTERSET_INFO":              "PPERF_COUNTERSET_INFO",
		"LPBOOL":                             "LPBOOL",
		"PPERF_PROVIDER_CONTEXT":             "PPERF_PROVIDER_CONTEXT",
		"LPQUERY_SERVICE_CONFIGW":            "LPQUERY_SERVICE_CONFIG",
		"LPQUERY_SERVICE_LOCK_STATUSW":       "LPQUERY_SERVICE_LOCK_STATUS",
		"PFILETIME":                          "PFILETIME",
		"PVALENTW":                           "PVALENT",
		"PSAFER_CODE_PROPERTIES":             "PSAFER_CODE_PROPERTIES",
		"LPSERVICE_TABLE_ENTRYW":             "LPSERVICE_TABLE_ENTRY",
		"SERVICE_TABLE_ENTRYW*":              "*SERVICE_TABLE_ENTRY",
		"PPROG_INVOKE_SETTING":               "PPROG_INVOKE_SETTING",
		"PSHA_CTX":                           "uintptr",
		"PTRACEHANDLE":                       "PTRACEHANDLE",
		"PEVENT_TRACE_PROPERTIES":            "PEVENT_TRACE_PROPERTIES",
		"PWNODE_HEADER":                      "PWNODE_HEADER",
		"PEVENT_FILTER_DESCRIPTOR":           "PEVENT_FILTER_DESCRIPTOR",
		"PENABLE_TRACE_PARAMETERS":           "PENABLE_TRACE_PARAMETERS",
		"PTRACE_GUID_PROPERTIES":             "PTRACE_GUID_PROPERTIES",
		"PEVENT_DESCRIPTOR":                  "PEVENT_DESCRIPTOR",
		"PEVENT_DATA_DESCRIPTOR":             "PEVENT_DATA_DESCRIPTOR",
		"PACTRL_ACCESSW":                     "PACTRL_ACCESS",
		"PACTRL_PROPERTY_ENTRYW":             "PACTRL_PROPERTY_ENTRY",
		"PACTRL_ACCESSW*":                    "*PACTRL_ACCESS",
		"PACTRL_AUDITW":                      "PACTRL_AUDIT",
		"PACTRL_AUDITW*":                     "*PACTRL_AUDIT",
		"PACTRL_ACCESS_ENTRY_LISTW":          "PACTRL_ACCESS_ENTRY_LIST",
		"PACTRL_ACCESS_ENTRYW":               "PACTRL_ACCESS_ENTRY",
		"PACCESS_RIGHTS":                     "PACCESS_RIGHTS",
		"PINHERIT_FLAGS":                     "PINHERIT_FLAGS",
		"PLSA_HANDLE":                        "PLSA_HANDLE",
		"LSA_HANDLE":                         "LSA_HANDLE",
		"PLSA_UNICODE_STRING":                "PLSA_UNICODE_STRING",
		"PTRUSTED_DOMAIN_AUTH_INFORMATION":   "PTRUSTED_DOMAIN_AUTH_INFORMATION",
		"PLSA_AUTH_INFORMATION":              "PLSA_AUTH_INFORMATION",
		"PTRUSTED_DOMAIN_INFORMATION_EX":     "PTRUSTED_DOMAIN_INFORMATION_EX",
		"PLSA_ENUMERATION_HANDLE":            "PLSA_ENUMERATION_HANDLE",
		"PLSA_REFERENCED_DOMAIN_LIST":        "PLSA_REFERENCED_DOMAIN_LIST",
		"PLSA_TRANSLATED_SID":                "PLSA_TRANSLATED_SID",
		"PLSA_TRUST_INFORMATION":             "PLSA_TRUST_INFORMATION",
		"PLSA_TRANSLATED_SID2":               "PLSA_TRANSLATED_SID2",
		"PLSA_TRANSLATED_NAME":               "PLSA_TRANSLATED_NAME",
		"PLSA_OBJECT_ATTRIBUTES":             "PLSA_OBJECT_ATTRIBUTES",
		"PPOLICY_INFORMATION_CLASS":          "PPOLICY_INFORMATION_CLASS",
		"PTRUSTED_INFORMATION_CLASS":         "PTRUSTED_INFORMATION_CLASS",
		"MD4_CTX*":                           "uintptr",
		"MD5_CTX*":                           "uintptr",
		"PEVENT_TRACE_LOGFILEW":              "PEVENT_TRACE_LOGFILE",
		"PEVENT_TRACE":                       "PEVENT_TRACE",
		"PEVENT_TRACE_HEADER":                "PEVENT_TRACE_HEADER",
		"PTRACE_LOGFILE_HEADER":              "PTRACE_LOGFILE_HEADER",
		"PTIME_ZONE_INFORMATION":             "PTIME_ZONE_INFORMATION",
		"LPTIME_ZONE_INFORMATION":            "LPTIME_ZONE_INFORMATION",
		"PETW_BUFFER_CONTEXT":                "PETW_BUFFER_CONTEXT",
		"PEVENT_RECORD":                      "PEVENT_RECORD",
		"PEVENT_HEADER":                      "PEVENT_HEADER",
		"PEVENT_HEADER_EXTENDED_DATA_ITEM":   "PEVENT_HEADER_EXTENDED_DATA_ITEM",
		"struct ustring*":                    "uintptr",
	...
	tableFunc := map[string]string{
		...
		"PFN_SC_NOTIFY_CALLBACK":              "PFN_SC_NOTIFY_CALLBACK",
		"PWAITCHAINCALLBACK":                  "PWAITCHAINCALLBACK",
		"PERFLIBREQUEST":                      "PERFLIBREQUEST",
		"PERF_MEM_ALLOC":                      "PERF_MEM_ALLOC",
		"PERF_MEM_FREE":                       "PERF_MEM_FREE",
		"PFE_EXPORT_FUNC":                     "PFE_EXPORT_FUNC",
		"LPHANDLER_FUNCTION":                  "LPHANDLER_FUNCTION",
		"PCOGETACTIVATIONSTATE":               "PCOGETACTIVATIONSTATE",
		"PCOGETCALLSTATE":                     "PCOGETCALLSTATE",
		"LPSERVICE_MAIN_FUNCTIONW":            "LPSERVICE_MAIN_FUNCTION",
		"FN_PROGRESS":                         "FN_PROGRESS",
		"PFE_IMPORT_FUNC":                     "PFE_IMPORT_FUNC",
		"PEVENT_CALLBACK":                     "PEVENT_CALLBACK",
		"PEVENT_RECORD_CALLBACK":              "PEVENT_RECORD_CALLBACK",
		"PEVENT_TRACE_BUFFER_CALLBACKW":       "PEVENT_TRACE_BUFFER_CALLBACK",
		"PEVENT_TRACE_BUFFER_CALLBACK":        "PEVENT_TRACE_BUFFER_CALLBACK",
	}
